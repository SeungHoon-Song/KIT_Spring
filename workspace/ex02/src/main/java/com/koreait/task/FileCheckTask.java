...
public class FileCheckTask {
	...
	public void checkFiles() throws Exception{
		...
		//순서가 있는 Stream형태 객체는 collect메소드를 통하여 Collection Framework 타입으로 변경시켜 사용이 가능하다.
		...
		.forEach(p -> fileListPaths.add(p));	//어제 올린 첨부파일 중 이미지 파일들은 fileListPaths에 s_ 경로까지 추가해준다.
